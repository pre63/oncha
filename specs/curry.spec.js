...
describe('A curry', () => {
  it('should curry a function', () =>
    assert.equal(curry((a, b, c) => a + b + c)(1, 2, 3), 6))
  ...
  it('should return a curried function', () =>
    assert.equal(curry(add)(1)(2, 3), add(1, 2, 3)))

  it('should return a curried function', () =>
    assert.equal(curry(add)(1, 2)(1), add(1, 2, 1)))

  it('should return a curried function', () =>
    assert.equal(curry(add)(2)(1)(2), add(2, 1, 2)))

  it('should return a curried function', () =>
    assert.equal(curry(multiply)(2)(3), multiply(2, 3)))
